module.exports = {
    "hearts": {
        ...
        image: "/assets/images/materials/heart.png",
    },
    "feather": {
        title: "Feather",
    ...
    "green aventurine": {
        ...
        image: "/assets/images/materials/aventurine.png",
    },
    "aventurine": {
        title: "Green Aventurine",
        text: "Leadership, properity, self-confidence, balance. Releases blocks to moving forward. Attracts love and healing",
    ...
    "lava stone": {
        ...
        image: "/assets/images/materials/lava-stone.png",
    },
    "dragon vein agate": {
    ...
    "synthetic amber beads": {
        ...
        image: "/assets/images/materials/amber.png",
    },
    "amber pendant": {
        title: "Amber",
        text: "Teething pain, absorbs negative energy, protection, transmutes to healing, clarity, self-confidence, wisdom and expression",
    ...
    "fuchsia agate": {
        ...
        image: "/assets/images/materials/fuchsia-agate.png",
    },
    "pink fuchsia agate": {
        title: "Pink Fuchsia Agate",
        text: "Love, releases anger and negativity, self-confidence and positivity",
        image: "/assets/images/materials/pink-fuchsia-agate.png",
    },
    "blue jasper": {
        title: "Blue Jasper",
        text: "Spirituality, communication, balances ying and yang energy. Aligns and balances energy centers",
        image: "/assets/images/materials/blue-jasper.png",
    },
    "labradorite": {
        title: "Labradorite",
        text: "Strengthens will, psychic development, imagination, calmness and transformation",
        image: "/assets/images/materials/labradorite.png",
    },
    "chrysoberyl cats-eye": {
        title: "Chrysoberyl Cats-Eye",
    ...
    "black spacers": {
        ...
        image: "/assets/images/materials/black-colour.png",
    },
    "blue feature bead": {
        title: "Blue",
        text: "Colour of healers, tranquility, trust, intuition communication and calmness",
        image: "/assets/images/materials/blue-feature.png",
    },
    "blue hardened glass": {
        title: "Blue",
        text: "Placeholder",
        image: "/assets/images/materials/blue-hardened-glass.png",
    },
    "red feature bead": {
        title: "Red",
        text: "Energy, action, confidence, power and change",
        image: "/assets/images/materials/red-feature.png",
    },
    "red glass": {
        title: "Red Glass",
        text: "Energy, action, confidence, power and change",
        image: "/assets/images/materials/red-glass.png",
    },
    "orange spacers": {
        title: "Orange",
        text: "Motivation, personal power, sexuality and joy",
        image: "/assets/images/materials/orange-spacers.png",
    },
    "orange hardened glass": {
        title: "Orange",
        text: "Motivation, personal power, sexuality and joy",
        image: "/assets/images/materials/orange-hardened-glass.png",
    },
    "malachite": {
        title: "Malachite",
    ...
    "yellow cat's eye": {
        title: "Yellow Cat's Eye",
        text: "Transforms negative though, happiness, optimism and generosity",
        image: "/assets/images/materials/yellow-cats-eye.png",
    },
    "purple rose": {
        title: "Purple Rose",
        text: "Royality, love and enchantment",
        image: "/assets/images/materials/purple-rose.png",
    },
    "snowflake obsidian": {
        title: "Snowflake Obsidian",
        text: "Balances body, mind and spirit and releases negative energy",
        image: "/assets/images/materials/snowflake-obsidian.png",
    },
    "white howlite": {
        title: "White Howlite",
        text: "Attunement, higher conciousness, reduces anxiety, tension and stress. Aids emotional expression",
        image: "/assets/images/materials/white-howlite.png",
    },
    "red coral": {
        title: "Red Coral",
        text: "Increases self-esteem, sea energy, success in business, leadership roles, strength, passion, changes and health",
        image: "/assets/images/materials/red-coral.png",
    },
    "blue/green czech glass": {
        title: "Czech Glass",
        text: "Placeholder",
        image: "/assets/images/materials/blue-green-czech.png",
    },
    "turquoise czech glass": {
        title: "Czech Glass",
        text: "Placeholder",
        image: "/assets/images/materials/turquoise-czech.png",
    },
    "green czech glass": {
        title: "Czech Glass",
        text: "Placeholder",
        image: "/assets/images/materials/green-czech.png",
    },
    "Purple czech glass": {
        title: "Czech Glass",
        text: "Placeholder",
        image: "/assets/images/materials/purple-czech.png",
    },
    "rune (water)": {
        title: "Rune Bead (Water)",
        text: "Placeholder",
        image: "/assets/images/materials/rune-water.png",
    },
    "rune (gebo)": {
        title: "Rune Bead (Gebo)",
        text: "Placeholder",
        image: "/assets/images/materials/rune-gebo.png",
    },
    "rune (laguz)": {
        title: "Rune Bead (Laguz)",
        text: "Placeholder",
        image: "/assets/images/materials/rune-laguz.png",
    },
    "rune (laguz)": {
        title: "Rune Bead (Laguz)",
        text: "Placeholder",
    ...
    "rune (sowilo)": {
        title: "Rune Bead (Sowilo)",
        text: "Placeholder",
        image: "/assets/images/materials/rune-sowilo.png",
    },
    "moss agate": {
        title: "Moss Agate",
        text: "Placeholder",
        image: "/assets/images/materials/moss-agate.png",
    },
    "grey agate": {
        title: "Grey Agate",
        text: "Placeholder",
        image: "/assets/images/materials/grey-agate.png",
    },
    "blue agate": {
        title: "Blue Agate",
        text: "Placeholder",
        image: "/assets/images/materials/blue-agate.png",
    },
    "reclaimed": {
        title: "30% Reclaimed Materials",
        text: "All items are made with 30% reclaimed materials in service of Mother Earth",
        image: "/assets/images/icons/recycle-black.svg",
    },
    "earrings": {
        title: "Earrings",
        text: "Earrings are made using stainless steel ear wires",
        image: "/assets/images/materials/earrings.png",
    },
}
